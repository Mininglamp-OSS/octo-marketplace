...
UPDATE categories c
JOIN default_skill_category_taxonomy t ON t.name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
...
LEFT JOIN categories c ON c.name COLLATE utf8mb4_0900_ai_ci = t.name COLLATE utf8mb4_0900_ai_ci AND c.deleted_at IS NULL
WHERE c.id IS NULL;
...
JOIN default_skill_category_remap r ON r.from_name COLLATE utf8mb4_0900_ai_ci = old_category.name COLLATE utf8mb4_0900_ai_ci
JOIN categories new_category ON new_category.name COLLATE utf8mb4_0900_ai_ci = r.to_name COLLATE utf8mb4_0900_ai_ci AND new_category.deleted_at IS NULL
...
UPDATE categories c
JOIN default_skill_category_remap r ON r.from_name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
LEFT JOIN default_skill_category_taxonomy t ON t.name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
