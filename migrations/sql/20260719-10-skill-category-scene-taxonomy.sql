...
UPDATE categories c
JOIN category_taxonomy t ON t.name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
...
UPDATE categories c
JOIN category_taxonomy t ON t.legacy_name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
LEFT JOIN categories existing ON existing.name COLLATE utf8mb4_0900_ai_ci = t.name COLLATE utf8mb4_0900_ai_ci AND existing.id <> c.id
SET c.name = t.name,
...
LEFT JOIN categories c ON c.name COLLATE utf8mb4_0900_ai_ci = t.name COLLATE utf8mb4_0900_ai_ci
WHERE c.id IS NULL;
...
JOIN category_remap r ON r.from_name COLLATE utf8mb4_0900_ai_ci = old_category.name COLLATE utf8mb4_0900_ai_ci
JOIN categories new_category ON new_category.name COLLATE utf8mb4_0900_ai_ci = r.to_name COLLATE utf8mb4_0900_ai_ci
...
UPDATE categories c
JOIN category_remap r ON r.from_name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
LEFT JOIN category_taxonomy t ON t.name COLLATE utf8mb4_0900_ai_ci = c.name COLLATE utf8mb4_0900_ai_ci
